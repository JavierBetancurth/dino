...
def train_dino(args):
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_stats = train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, llp_loss,
...
def train_one_epoch(student, teacher, teacher_without_ddp, dino_loss, llp_loss, data_loader,
...
class LLPLoss(nn.Module):
    ...
    def forward(self, student_output, teacher_output, true_proportions):
        """
        Args:
            student_output: Predictions from the student model (logits in `out_dim` space).
            teacher_output: Predictions from the teacher model (logits in `out_dim` space).
